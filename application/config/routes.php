...
$route['admin/autores/editar/(:num)'] = 'admin/autores/editar/$1';
...
$route['admin/post/todos-los-post/(:num)'] = 'admin/post/index/$1';
$route['admin/post/editar/(:num)'] = 'admin/post/editar/$1';
