                        ...
                        <tbody>
	                        <?php foreach ($autores as $a=> $val){ ?>
	                        	  <tr>
	                            	...
	                            	<td>
	                            		<a href="#" class="btn btn-small btn-info" value="<?php echo $val->id ?>"><i class="fa fa-pencil"></i></a>
	                            		<a href="#" class="btn btn-small btn-danger" name="" value="<?php echo $val->id ?>"><i class="fa fa-trash"></i></a>
	                            	</td>
	                            </tr>
	                        <?php } ?>
	                    	</tbody>
